...
export function InlineError({ title, details, onRetry }: InlineErrorProps) {
  return (
    <div role="alert" className="border border-danger rounded-md p-3 text-13 text-danger flex items-start gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        {details && (
          <details>
            <summary className="cursor-pointer text-12">View details</summary>
