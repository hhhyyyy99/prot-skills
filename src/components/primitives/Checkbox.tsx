...
function Checkbox({ id, checked, onChange, disabled, 'aria-label': ariaLabel, label }: CheckboxProps) {
  ...
  return (
    <div className="inline-flex items-center gap-2">
      ...
      {label && <label htmlFor={id} className="text-13 text-text-primary select-none">{label}</label>}
    </div>
  );
}
