...
describe('DetailPanel', () => {
  it('focuses close button when open becomes true', async () => {
    ...
    const { rerender, getByLabelText } = render(
      <DetailPanel open={false} onClose={onClose} title="T">body</DetailPanel>
    );
    rerender(<DetailPanel open={true} onClose={onClose} title="T">body</DetailPanel>);
  ...
  it('calls onClose on Escape key', () => {
    ...
    const { getByRole } = render(
      <DetailPanel open={true} onClose={onClose} title="T">body</DetailPanel>
    );
