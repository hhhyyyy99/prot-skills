...
describe('CommandBar', () => {
  it('renders nothing when closed', () => {
    const { container } = render(<CommandBar open={false} onOpenChange={vi.fn()} commands={mockCommands} />, { wrapper: LanguageProvider });
    expect(container.innerHTML).toBe('');
  });

  it('renders dialog with input focused when open', () => {
    render(<CommandBar open={true} onOpenChange={vi.fn()} commands={mockCommands} />, { wrapper: LanguageProvider });
  ...
  it('calls perform and closes on item select', async () => {
    ...
    render(<CommandBar open={true} onOpenChange={onOpenChange} commands={mockCommands} />, { wrapper: LanguageProvider });
